...
internal static class ImageResizer
{
    ...
    /// </summary>
    private static (int width, int height) CalculateFitDimensions(int sourceWidth, int sourceHeight, int maxWidth,
        int maxHeight)
    {
    ...
    /// </summary>
    private static (int width, int height) CalculateFillDimensions(int sourceWidth, int sourceHeight, int minWidth,
        int minHeight)
    {
        double sourceRatio = (double)sourceWidth / sourceHeight;
    ...
    public static byte[] Resize(byte[] imageData, int width, int height, LegioScaleMode mode = LegioScaleMode.Fit,
