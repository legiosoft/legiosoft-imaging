...
public class ImageSaverTests
{
    ...
    public void SaveBitmap_FormatComparison_PerformanceAcceptable()
    {
        ...
        _output.WriteLine($"PNG: {pngStopwatch.ElapsedMilliseconds}ms, JPEG: {jpegStopwatch.ElapsedMilliseconds}ms, WebP: {webPStopwatch.ElapsedMilliseconds}ms");
        Assert.True(pngStopwatch.ElapsedMilliseconds < 10000 && jpegStopwatch.ElapsedMilliseconds < 10000 && webPStopwatch.ElapsedMilliseconds < 10000, 
    ...
    public void SaveBitmap_QualityVsPerformance_ReasonableTradeoff()
    {
        ...
        _output.WriteLine($"Low quality: {lowQualityStopwatch.ElapsedMilliseconds}ms, High quality: {highQualityStopwatch.ElapsedMilliseconds}ms");
    ...
    public void SaveBitmap_ByteArrayVsStream_PerformanceComparison()
    {
        ...
        _output.WriteLine($"Array: {arrayStopwatch.ElapsedMilliseconds}ms, Stream: {streamStopwatch.ElapsedMilliseconds}ms");
    ...
    public void SaveBitmap_VariousSizes_PerformanceScales()
    {
        ...
        _output.WriteLine($"Performance by size: {string.Join(", ", results.Select(kvp => $"{kvp.Key}px: {kvp.Value}ms"))}");
